          ...
          <View style={styles.topContainer}>
            <View style={styles.txtinputContainer}>
              <AppTextinput
                ...
                defaultValue={this.props.userData['user']['name']}
              />
              <AppTextinput
                name={'Email'}
              ...
              <TouchableOpacity
                ...
                <AppTextinput
                  ...
                  editable={false}
                  defaultValue={this.props.userData['user']['date_of_birth']}
                />
                <View>
              ...
              <AppTextinput
                ...
                defaultValue={this.props.userData['user']['disease']}
              />
              ...
              <View style={{margin: 12}}>
                <RNModalPicker
                  ...
                  placeHolderLabel={this.props.userData['user']['district']}
